...
function(add_avr_executable EXECUTABLE_NAME)
    ...
    set_target_properties(
            ...
            LINK_FLAGS "-mmcu=${AVR_MCU} -Wl,--relax,--gc-sections -Wl,--gc-sections -Wl,-Map,${map_file}"
    )
    ...
    add_custom_target(
            ...
            COMMAND ${AVR_OBJDUMP} -h -S ${elf_file} > ${EXECUTABLE_NAME}.lst
            COMMAND avr-size ${elf_file}
            DEPENDS ${elf_file}
    )
